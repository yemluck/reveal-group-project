...
function AddRules() {
    ...
    const fillRulesform = (evt) => {
        console.log('in fill rules')
        setValueCategory("Environment")
        setMembershipName('Natural Resources Defense Council')
        setPointsEarned(2)
        setIndustryCategory('Oil and Gas')
    }
